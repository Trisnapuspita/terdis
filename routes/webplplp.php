...
Route::group(['middleware' => 'auth'], function() {
    Route::get('/materikelas', 'MateriController@index2');
    Route::get('/materikelas/{id}', 'MateriController@show2');
    Route::get('/materi', 'MateriController@index');
    Route::get('/materi/{id}', 'MateriController@show');
    Route::get('/soalkelas', 'SoalController@index2');
    Route::get('/soalkelas/{id}', 'SoalController@show2');
