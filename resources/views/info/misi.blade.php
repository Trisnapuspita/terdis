            ...
            <div class="col-md-12">
                ...
                <div class="portlet box green">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-globe"></i>Daftar Misi </div>
                        <div class="tools"> </div>
                    </div>
                        ...
                        <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="sample_3" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{$i++}}</td>
                                    <td>{{ $misi->poin }}</td>
                                    <td><a href="/misi/{{ $misi->id }}" class="btn btn-primary btn-sm">Edit</a></td>
                                    <td>
