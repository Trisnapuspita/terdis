                ...
                <div class="panel-body">
                    ...
                    <table class="table table-sm">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th width="600px" style="text-align: center">Misi</th>
                                <th> </th>
                                <th> </th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <th style="font-weight: normal">{{ $misi->poin }}</th>
                                <th><a href="/misi/{{ $misi->id }}" class="btn btn-primary btn-sm">Edit</a></th>
                                <th>
                    ...
                    <p style="margin-left: 235px"><a href="/misi/create" class="btn btn-primary btn-md">Tambah</a>
