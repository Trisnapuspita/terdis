                    ...
                    <form action="/pengajar/soal" method="POST" enctype="multipart/form-data" class="form-horizontal form-bordered">
                        <div class="form-body">
                            ...
                            <div class="form-group form-md-radios">
                                <label class="col-md-2 control-label" style="color:black">Jenis</label>
                                <div class="col-md-10">
                                    <div class="md-radio-inline">
                                        <div class="md-radio">
                                            ...
                                            <label for="radio1">
                                                <span></span>
                                                <span class="check"></span>
                                                <span class="box"></span> Latihan </label>
                                        </div>
                                        <div class="md-radio">
                                            ...
                                            <label for="radio2">
                                                <span></span>
                                                <span class="check"></span>
                                                <span class="box"></span> Ujian </label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-2">Waktu Ujian</label>
                                <div class="col-md-2">
