...
@section('title')
Teras Diskusi | Daftar Mata Pelajaran
@endsection
            ...
            <div class="col-md-12">
                ...
                <div class="portlet box green">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-globe"></i>Daftar Mata Pelajaran </div>
                        <div class="tools"> </div>
                    </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center">
                                        <a href="/matapelajaran/{{ $mapel->id }}/edit" class="btn btn-primary btn-sm">Edit</a>
                                    </td>
                                    <td style="text-align:center">
                                            <form action="/matapelajaran/{{ $mapel->id }}" method="POST">
